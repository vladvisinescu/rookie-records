    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-1/2 mb-8 lg:w-1/4">
            ...
            <div class="flex gap-x-4 lg:justify-end">
                ...
                <a href="https://www.facebook.com/rookierecords.uk" class="h-8 w-8 text-center py-1">
                    <svg role="img" class="h-8 w-8 inline-block m-0" style="margin: 0 !important; fill: #1877F2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
