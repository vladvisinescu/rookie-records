<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 mb-10">
        <div class="flex flex-col">
            <div class="mb-8">
                <h1 class="text-xl font-bold text-gray-700 border-b-4 border-gray-300 inline">Contact Us</h1>
            </div>
            <div class="prose max-w-full mb-8">
                <p>Here you can:</p>
                <ul>
                    <li>provide feedback about the website</li>
                    <li>let us know of any issues you come across while using it</li>
                    <li>talk to us about any enquiry that you may have</li>
                </ul>
