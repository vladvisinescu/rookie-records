...
<!--                <div class="absolute inset-0 bg-indigo-500 bg-opacity-0 transition-all transition-ease-in group-hover:bg-opacity-10" style="mix-blend-mode: darken"></div>-->
        ...
        <a href="javascript:;" class="flex justify-between text-sm hover:bg-gray-100 transition-all" v-if="buttons">
            ...
            <span class="w-1/3 text-center py-3 px-4" v-text="'£' + product.price"></span>
        </a>
    </div>
</template>
